...
# pytest -s -v -m "not smoke" test_xxx.py

# Чтобы запустить только smoke-тесты для macOS, нужно использовать логическое И:
# pytest -s -v -m "smoke and win10" test_xxx.py
